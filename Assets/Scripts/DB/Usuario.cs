...
public class Usuario : MonoBehaviour
{
   ...
   string MostrarUser="https://prime-pruebasweb.com/rankingstack/iniciar.php";
   
  // string MostrarUser="http://localhost/paginaweb/Prime%20Digital%20Pruebas/Juego%20Stacks/Scores/iniciar.php";
